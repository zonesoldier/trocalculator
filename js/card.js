...
,[422,999,"Detardeurus",0,19,-20,221,84,0] //custom TalonRO remove freeze immunity //Removed from CardSortOBJ, duplicate with 532 Detale Card.
...
,[497,999,"Beelzebub NPC Card","<br><b>*Warning*</b>Having more then one Beelzebub NPC Card doesn't give -60% cast, it will give you -30% always.<b>*Warning*</b>",73,-30,0]
		...
		if(inputArray[i][1] > 0 && inputArray[i][1] < 8){
			for(j = tempArray[inputArray[i][1]].length - 1; j >= 0; j--){
				if(inputArray[i][2] > inputArray[tempArray[inputArray[i][1]][j]][2]){
					...
					if(inputArray[i][1] == 1){
						tempArray[0].splice(j + 1, 0, inputArray[i][0]);
					}
					break;
				}
			}
