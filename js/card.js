...
,[112,10,"Andre Larva",0,4,1,14,10,0]
...
,[161,1,"Whitesmith[MVP]","Add a low chance to cast Level 4 Meltdown when attacking",0] //custom TalonRO low chance for lv4 Meltdown
,[162,1,"Sniper[MVP]","When attacking with an ATK based attack, adds a 10% chance to absorb 20% of the damage inflicted on the enemy as HP",75,-10,0] //custom TalonRO 10% chance to absorb instead of 5%; HPregen -10% instead of -100%
,[163,1,"Breeze",0,17,5,138,5,0]
,[164,1,"Lady Solace","When equipped by a priest:<BR>When attacking with an ATK based attack, adds a chance to autocast [Grand Cross]Lv 5",0]
...
,[178,2,"Lord Knight[MVP]","Add a 5% chance to autocast Joint Beat lvl 5 when attacking",0] //custom TalonRO no Berserk effect, but autocast Joint Beat
...
,[219,5,"Lord of the Dead",0,3,10,190,10,191,10,192,10,0] //custom TalonRO -10% dmg of monster sizes; vit+10 - diff position
...
,[251,7,"Poison Toad","Causes Envenom to push the target 5 cells back",221,65,0]
...
,[254,1,"Shellfish","Increase damage on [Crab] by 30%",1072,30,17,5,0]
...
,[308,4,"Skel. Prisoner","3% chance of inflicting [Sleep] status when receiving ATK based damage",0]
...
,[330,4,"Demon Fungus","6% chance of inflicting [Sleep] status when receiving ATK based damage",0]
...
,[345,1,"Nereid","Regain 5 SP when killing a Brute race monster with a ATK based attack<BR>Drains 5 SP when the weapon is unequipped",0]
...
,[358,3,"Parasite","[description translation missing - ItemID: 358]",60,5,18,1,0]
,[359,1,"Fake Angel","Regain 5 SP when killing a Angel race monster with a ATK based attack<BR>Drains 5 SP when the weapon is unequipped",0]
...
,[404,4,"Assassin Cross Eremes[MVP]","Add a 6% chance of inflicting Critical Wounds Level 3 on an enemy when the user receives Physical Damage (not calced)",0] //custom TalonRO - diff position
...
,[463,1,"Atroce","When performing a ATK based attack there is a 0.5% chance that will set your attack speed to 190 for 10seconds",17,25,0]
...
,[486,4,"Fallen Bishop","Add a 100% chance of auto casting Level 2 Magic Mirror when the user receives Magical Damage",0] //custom TalonRO add autocast; removed matk stuff - diff position
...
,[501,4,"Entweihen Crothen[MVP]","MATK + 100<BR><b>*Warning*</b>MATK Bonus not implemented yet<b>*Warning*</b>",0]
...
,[509,2,"Rata","MATK + 10<BR><b>*Warning*</b>MATK Bonus not implemented yet<b>*Warning*</b>",0]
...
