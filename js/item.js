...
,[1654,50,79,4,0,1,240,70,"Enhanced Hat of the Sun God [1]","","A hat that is said to have been worn by the god of the sun.<br>[Refine Rate 5~6+]<br>ATK + 4, MATK + 1%<br>[Refine Rate 7+]<br>ATK + 6, MATK + 1%<br>[Refine Rate 8+]<br>ATK + 6, MATK + 2%",1,3,4,2,17,10,89,5,0]
,[1655,50,79,5,0,1,160,74,"Enhanced Helm of Angel [1]","","A wondrous helmet adorned with angel wings that was made by a smithing genius.<br>[Refine Rate 5~6+]<br>AGI + 1, LUK + 1, MDEF + 1<br>[Refine Rate 7+]<br>ASPD + 1",2,1,6,1,19,3,12,5,0]
,[1656,50,70,5,0,1,240,70,"Enhanced Bone Helm [1]","","An incredibly heavy, yet almost impenetrable helmet constructed of bone.<br>Every refine level past +4 until +8 reduces DEF by 1 and decreases damage received from Neutral Property attacks by another 1%.",60,1,67,-15,0]
,[1657,50,1,5,0,1,50,70,"Enhanced Corsair [1]","","A flamboyant hat worn only by the strongest of pirates.<br>[Refine Rate 5~7+]<br>Maximum HP + 1%<br>[Refine Rate 8+]<br>Maximum HP + 2%<br>Reduce another 1% damage from Neutral type attacks.",3,1,15,5,60,1,0]
